...
<head>
  <!-- Title -->
  <title><?php echo "Fotografie -".$info_website_name; ?></title>
  ...
  <!-- Schema.org -->
  <meta itemprop="name" content="<?php echo "Fotografie -".$info_website_name; ?>">
  <meta itemprop="url" content="<?php echo $websiteUrl."photography/"; ?>">
  <meta itemprop="description" content="Finde alles über unsere Services für Fotografie heraus.">
  ...
  <meta name="twitter:title" content="<?php echo "Fotografie -".$info_website_name; ?>">
  <meta name="twitter:url" content="<?php echo $websiteUrl."photography/"; ?>">
  <meta name="twitter:description" content="Finde alles über unsere Services für Fotografie heraus.">
  <meta name="twitter:image" content="../assets/img/backgrounds/home.jpg">

  <!-- Open Graph -->
  <meta property="og:title" content="<?php echo "Fotografie -".$info_website_name; ?>">
  <meta property="og:type" content="website">
  <meta property="og:url" content="<?php echo $websiteUrl."photography/"; ?>">
  <meta property="og:image" content="../assets/img/backgrounds/home.jpg">
  <meta property="og:description" content="Finde alles über unsere Services für Fotografie heraus.">
