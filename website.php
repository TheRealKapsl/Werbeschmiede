...
<head>
  <!-- Title -->
  <title><?php echo "Website - ".$info_website_name; ?></title>
  ...
  <!-- Schema.org -->
  <meta itemprop="name" content="<?php echo "Website - ".$info_website_name; ?>">
  <meta itemprop="url" content="<?php echo $websiteUrl."website/"; ?>">
  <meta itemprop="description" content="Finde alles über unsere Website-Services heraus.">
  ...
  <meta name="twitter:title" content="<?php echo "Website - ".$info_website_name; ?>">
  <meta name="twitter:url" content="<?php echo $websiteUrl."website/"; ?>">
  <meta name="twitter:description" content="FFinde alles über unsere Website-Services heraus.">
  <meta name="twitter:image" content="../assets/img/backgrounds/home.jpg">

  <!-- Open Graph -->
  <meta property="og:title" content="<?php echo "Website - ".$info_website_name; ?>">
  <meta property="og:type" content="website">
  <meta property="og:url" content="<?php echo $websiteUrl."website/"; ?>">
  <meta property="og:image" content="../assets/img/backgrounds/home.jpg">
  <meta property="og:description" content="Finde alles über unsere Website-Services heraus.">
    ...
    <div class="container duik-promo-container">
      <div class="d-flex justify-content-center position-relative mh-25rem pt-11 py-6">
        <div class="align-self-center w-md-75">
          ...
          <p class="text-light mb-0">Finde alles über unsere Website-Services heraus.</p>
        </div>
      </div>
    </div>
